...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	call <SID>X("Search", s:background, s:searchBG, "")
	...
	call <SID>X("qfError", s:foreground, "", "")
	...
	call <SID>X("jsObjectKey", s:skin, "", "")
	call <SID>X("jsObject", s:skin, "", "")
	call <SID>X("jsClassProperty", s:foreground, "", "")
	call <SID>X("jsFuncCall", s:red, "", "")
	call <SID>X("jsClassKeywords", s:purple, "", "")
	call <SID>X("jsUndefined", s:purple, "", "")
	call <SID>X("jsNull", s:purple, "", "")
	call <SID>X("jsModuleGroup", s:skin, "", "")
	call <SID>X("jsImportContainer", s:skin, "", "")
	...
	" Diff Highlighting
	call <SID>X("DiffText", "", s:diffBG, "")
	call <SID>X("DiffChange", "", s:diffBG, "")
	call <SID>X("DiffAdd", "", s:diffBG, "")
	call <SID>X("DiffDelete", "", s:diffBG, "")
